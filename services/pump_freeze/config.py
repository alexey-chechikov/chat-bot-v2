...
# ─── Cooldown (после resume — не fire-ить тот же бот) ───────────────────────
PUMP_COOLDOWN_MIN = 60           # min gap между resume и next freeze (per bot)
...
RESUME_TIMEOUT_HOURS = 4         # bumped 2→4 per колегин sweep recommendation
